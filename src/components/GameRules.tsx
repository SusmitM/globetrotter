      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <ul className="list-disc pl-5 mt-5">
            <p className="font-bold text-white font-lg mb-2 flex items-center gap-2"><TrophyIcon className="h-4 w-4 text-blue-500"/> Scoring:</p>
              ...
              <ul className="list-disc pl-5 mt-5">
              <p className="font-bold text-white font-lg mb-2 flex items-center gap-2"><Clock className="h-4 w-4 text-blue-500"/> Gameplay:</p>
